...
# 2.  [Reading train file](#Reading train file)
# 3.  [Viewing data](#Viewing data)
# 4.  [Missing Value check](#Missing Value check)
# 5.  [Check count distribution of target variable](#Check count distribution of target variable)
# 6.  [Visualize count distribution of target variable](#Visualize count distribution of target variable)
# 7.  [Visualize the proportion of target variable](#Visualize the proportion of target variable)
# 8.  [Determine accuracy for majority class classifier](#Determine accuracy for majority class classifier)
# 9.  [Correlation of Target and Numeric Predictors](#Correlation of Target and Numeric Predictors)
# 10. [Correlation of Target and Categorical Predictors](#Correlation of Target and Categorical Predictors)
```
...
# 5. Check count distribution of target variable
```{r}
...
# 6. Visualize count distribution of target variable
```{r}
library(ggplot2)
...
# 7. Visualize the proportion of target variable
```{r}
...
# 8. Determine accuracy for majority class classifier
```{r}
...
# 9. Correlation of Target and Numeric Predictors
```{r}
...
# 10. Correlation of Target and Categorical Predictors
```{r}
